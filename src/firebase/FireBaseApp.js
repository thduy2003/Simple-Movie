    ...
    <div className="p-10">
      <div className="w-full max-w-[500px] mx-auto bg-white shadow-lg p-5 mb-10">
        <form onSubmit={handleAddPost}>
          <input
            type="text"
            className=" text-black p-3 rounded border border-gray-200 w-full mb-5 outline-none focus:border-blue-500"
      ...
      <div className="w-full max-w-[500px] mx-auto bg-white shadow-lg p-5 mb-10">
        {posts.length > 0 &&
          posts.map((item) => (
            <div className="text-black" key={item.title}>
              <div>
